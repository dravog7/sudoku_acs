...
sudokusolver : board.o sudokuant.o sudokuantsystem.o backtracksearch.o solvermain.o sudokuAntGPE.o	
	$(CC) -o sudokusolver obj/board.o obj/sudokuant.o obj/sudokuantsystem.o obj/sudokuAntGPE.o obj/backtracksearch.o obj/solvermain.o
...
sudokuAntGPE.o:
	$(CC) $(CFLAGS) src/sudokuAntGPE.cpp -o obj/sudokuAntGPE.o
